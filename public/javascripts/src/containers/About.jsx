        ...
        <div className={style['center-vertically']}>
          ...
          <div className={style['section-wrapper']}>
            ...
            <div className={style.desc}>
              ...
              <p className={style['desc-paragraph']}>
